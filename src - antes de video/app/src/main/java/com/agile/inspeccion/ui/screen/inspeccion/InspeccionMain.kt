...
@Composable
fun InspeccionMain(navController: NavController, nombre: String, login: String, gruposModel: GruposViewModel) {
        ...
        Column(
            ...
            LazyColumn(
                ...
                itemsIndexed(grupos) { _, item ->
                    ListItem(item) {
                        navController.navigate("InspeccionLista/" + item.inspeccion.toString())
                    }
                }
            }
        }
