...
class ListActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var inspeccion: Int = 0;
        intent.extras?.let { bundle ->
            inspeccion = bundle.getInt("inspeccion", 0)
        }
        ...
        setContent {
            AppTheme {
                ...
                DetalleLibroScreen(inspeccion, viewModel)
            }
        }
    }
}*/
...
fun DetalleLibroScreen(navController: NavController, inspeccion: Int, viewModel: ListModel) {
    ...
    viewModel.GetDetalle(inspeccion)
